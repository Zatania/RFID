...
const DialogViewVehicles = ({ premium_id, refreshData }) => {
    ...
    <LocalizationProvider dateAdapter={AdapterDayjs}>
      <Box>
        ...
        >
            ...
            {vehicles.map((vehicle, index) => (
              <Grid container spacing={6} key={vehicle.id}>
                  ...
                  <TextField
                    ...
                    value={
                      vehicle.registration_expiration
                        ? dayjs(vehicle.registration_expiration).format('DD/MM/YYYY')
                        : null
                    }
                    InputProps={{
                      readOnly: true
                ...
                <Grid item sm={12} xs={12}>
                  ...
                  >
                    <DialogViewVehicle vehicle={vehicle} refreshData={() => fetchVehicles(premium_id)} />
                    <DialogDeleteVehicle vehicle_id={vehicle.id} refreshData={() => fetchVehicles(premium_id)} />
                  </Grid>
                </Grid>
              </Grid>
            ))}
          ...
          >
            <DialogAddVehicle premium_id={premium_id} refreshData={() => fetchVehicles(premium_id)} />

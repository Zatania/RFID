...
const DialogDeletePremium = ({ premium_id, refreshData }) => {
  ...
  const handleDeleteClick = () => {
    axios
      .delete(`/api/premium/${premium_id}`)
      .then(() => {
        toast.success('Premium User deleted successfully')
        handleClose()
      })
      .catch(error => {
        console.error(error)
        ...
        >
          ...
          <Box sx={{ mb: 8, textAlign: 'center' }}>
            <Typography variant='h6' gutterBottom>
              Are you sure you want to delete this premium user?
            </Typography>
          </Box>
        </DialogContent>
        <DialogActions
...
export default DialogDeletePremium

...
const DialogDeleteBAO = ({ bao_id, refreshData }) => {
  ...
  const handleDeleteClick = () => {
    axios
      .delete(`/api/bao/${bao_id}`)
      .then(() => {
        toast.success('BAO deleted successfully')
        handleClose()
      })
      .catch(error => {
        console.error(error)
        ...
        >
          ...
          <Box sx={{ mb: 8, textAlign: 'center' }}>
            <Typography variant='h6' gutterBottom>
              Are you sure you want to delete this bao?
            </Typography>
          </Box>
        </DialogContent>
        <DialogActions
...
export default DialogDeleteBAO

...
const DialogAddBAO = ({ refreshData }) => {
  ...
  const onSubmit = async data => {
    ...
    try {
      ...
      toast.success('BAO Added Successfully')
      handleClose()
    } catch (error) {
      if (error) {
        toast.error(error.message)
          ...
          >
            ...
            <Grid container spacing={6}>
              ...
              <Grid item sm={12} xs={12}>
                ...
                >
                  <Grid item sm={12} xs={12}>
                    <Typography variant='body1'>Upload BAO Profile Image</Typography>
                  </Grid>
                  <Grid item sm={12} xs={12}>
                    <FormControl>
                      <Input
